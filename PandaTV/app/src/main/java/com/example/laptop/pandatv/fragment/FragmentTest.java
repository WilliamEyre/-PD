...
import com.example.laptop.pandatv.adapter.MyAdapter;
import com.example.laptop.pandatv.adapter.MyAdapter1;
import com.example.laptop.pandatv.adapter.MyAdapter2;
import com.example.laptop.pandatv.adapter.MyAdapter3;
import com.example.laptop.pandatv.adapter.MyAdapter4;
import com.example.laptop.pandatv.base.BaseFragment;
import com.example.laptop.pandatv.bean.Student;
import com.example.laptop.pandatv.bean.Student1;
import com.example.laptop.pandatv.bean.Student2;
...
public class FragmentTest extends BaseFragment<LoginPresenter, LoginModel> implements LoginContract.View,View.OnClickListener {
    ...
    public void show(String url) {
        ...
        madapter.onClick(new MyAdapter.OnItemSet() {
            @Override
            public void onItem(View v, int position) {
                Student.DataBean.PandaeyeBean.ItemsBean itemsBean = items.get(position);
                Intent intent = new Intent(getActivity().getApplicationContext(), Main4Activity.class);
                intent.putExtra("name",itemsBean.getUrl());
                startActivity(intent);
            }
        });
